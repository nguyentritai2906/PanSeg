...
class Cityscapes(BaseDataset):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(Cityscapes, self).__init__(root, split, is_train, crop_size,
                                         mirror, min_scale, max_scale, resize,
        ...
        # print(len(self), _CITYSCAPES_INFORMATION.splits_to_sizes[self.split])
    ...
    def _get_files(self, data, dataset_split):
        ...
        search_files = os.path.join(self.root, _FOLDERS_MAP[data],
